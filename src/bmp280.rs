...
impl<I2C: ehal::blocking::i2c::WriteRead> BMP280<I2C> {
    ...
    pub fn pressure(&mut self) -> Result<f32, <I2C as ehal::blocking::i2c::WriteRead>::Error> {
        ...
        var1 = ((self.dig_p3 as f32) * var1 * var1 / 524288.0 + (self.dig_p2 as f32) * var1)
            / 524288.0;
        var1 = (1.0 + var1 / 32768.0) * (self.dig_p1 as f32);
        let mut pressure = 1048576.0 - (press as f32);
        if var1 != 0.0 {
            pressure = (pressure - (var2 / 4096.0)) * 6250.0 / var1;
            var1 = (self.dig_p9 as f32) * pressure * pressure / 2147483648.0;
    ...
    pub fn temp(&mut self) -> Result<f32, <I2C as ehal::blocking::i2c::WriteRead>::Error> {
        ...
        let v1 = ((temp as f32) / 16384.0 - (self.dig_t1 as f32) / 1024.0) * (self.dig_t2 as f32);
        let v2 = (((temp as f32) / 131072.0 - (self.dig_t1 as f32) / 8192.0)
            * ((temp as f32) / 131072.0 - (self.dig_t1 as f32) / 8192.0))
            * (self.dig_t3 as f32);
